...
log "安装 Playwright 浏览器依赖（适用于 Alibaba Cloud Linux 3 / RHEL8）..."
sudo dnf install epel-release -y || true
sudo dnf install https://download1.rpmfusion.org/free/el/rpmfusion-free-release-8.noarch.rpm -y || true
